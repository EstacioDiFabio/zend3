...
return [
    ...
    'controller_plugins' => [
        'factories' => [
            ...
            Controller\Plugin\WindelHtmlPlugin::class    => Controller\Plugin\Factory\WindelHtmlPluginFactory::class,
            Controller\Plugin\WindelFilterPlugin::class  => Controller\Plugin\Factory\WindelFilterPluginFactory::class,
            Controller\Plugin\WindelInputPlugin::class   => Controller\Plugin\Factory\WindelInputPluginFactory::class,
            Controller\Plugin\WindelAPIPlugin::class     => Controller\Plugin\Factory\WindelAPIPluginFactory::class,
        ],
        'aliases' => [
            'access'       => Controller\Plugin\AccessPlugin::class,
            'currentUser'  => Controller\Plugin\CurrentUserPlugin::class,
            'windelHtml'   => Controller\Plugin\WindelHtmlPlugin::class,
            'windelFilter' => Controller\Plugin\WindelFilterPlugin::class,
            'windelInput'  => Controller\Plugin\WindelInputPlugin::class,
            'windelAPI'    => Controller\Plugin\WindelAPIPlugin::class,
        ],
    ],
